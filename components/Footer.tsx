        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
          ...
          <div className="lg:col-span-1">
            <Link href="/" className="flex items-center space-x-2 mb-4">
              ...
              <span className="text-xl font-bold text-white">
                Wanderlust<span className="text-primary-400">Travels</span>
              </span>
            </Link>
            <p className="text-gray-400 mb-6 leading-relaxed">
              Crafting unforgettable travel experiences since 2010. Your adventure awaits with our handpicked destinations and expert guides.
            </p>
            {/* Social Links */}
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li>
                <Link href="/packages" className="hover:text-primary-400 transition-colors duration-200">
                  Tour Packages
                </Link>
              </li>
              <li>
                <Link href="/gallery" className="hover:text-primary-400 transition-colors duration-200">
                  Gallery
                </Link>
              </li>
              <li>
          ...
          {/* Destinations */}
          <div>
            <h3 className="text-white font-semibold text-lg mb-4">Top Destinations</h3>
            <ul className="space-y-3">
              <li>
                <a href="#" className="hover:text-primary-400 transition-colors duration-200">
                  Bali, Indonesia
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="md:flex md:items-center md:justify-between text-center md:text-left">
            <p className="text-gray-500 text-sm">
              &copy; {currentYear} WanderlustTravels. All rights reserved.
            </p>
            <div className="mt-4 md:mt-0 flex justify-center md:justify-end space-x-6 text-sm text-gray-500">
              <a href="#" className="hover:text-primary-400 transition-colors duration-200">
                Privacy Policy
              </a>
              <a href="#" className="hover:text-primary-400 transition-colors duration-200">
